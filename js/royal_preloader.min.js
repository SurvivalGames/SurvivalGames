...
var Royal_Preloader = {_overlay: null, _overlay_bg: null, _loader: null, _name: null, _percentage: null, _text_loader: null, _text_loader_overlay: null, _logo_loader: null, _logo_loader_meter: null, _total: 0, _loaded: 0, _image_queue: [], _percentage_loaded: 0, _mode: function() {
    ...
    _opacity: function() {
        ...
        return"undefined" !== typeof Royal_Preloader && "undefined" !==
                typeof Royal_Preloader._show_percentage ? Royal_Preloader._show_percentage : !0
    ...
    }(), _timeout: 10, _use_css_animation: !0, _css3SupportDetect: function() {
        var a = document.body.style;
        if ("string" == typeof a.transition)
            return Royal_Preloader._use_css_animation =
                    !0;
        ...
        "text" === this._mode && this._text_loader.css("margin-left", -1 * (this._text_loader.width() /
                2))
    }, _load: function() {
        ...
        if ("number" === this._mode) {
            ...
            this._use_css_animation ? this._overlay_bg.css("background-color", this._background[this._loaded % this._background.length]) : (this._name.css({opacity: 1, top: "50%"}), this._name.animate({top: "20%", opacity: 0}, 300), this._overlay_bg.animate({backgroundColor: this._background[this._loaded % this._background.length]}, 300, "linear"))
        }
        setTimeout(function() {
            b()
        },
        ...
        0 !== this._image_queue.length && (this._loaded++, Royal_Preloader._animatePercentage(Royal_Preloader._percentage_loaded, parseInt(100 * (this._loaded / this._total), 10)), this._show_info ? this._animateName(this._image_queue[0].name,
                this._reQueue) : this._reQueue())
        ...
        "undefined" !==
                typeof a.timeout && (this._timeout = parseInt(a.timeout));
        ...
        "undefined" !== typeof a.images && (this._images = a.images, Royal_Preloader._total = 0, $.each(this._images, function() {
            Royal_Preloader._total++
        }))
    }};
