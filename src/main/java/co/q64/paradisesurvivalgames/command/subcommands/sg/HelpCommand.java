...
public class HelpCommand implements SubCommand {
            ...
            if (args.length == 0) {
                ...
                switch (page) {
                    ...
                    case 3:
                        ...
                        p.sendMessage(ChatColor.GOLD + "--------------" + ChatColor.DARK_AQUA + I18N.getLocaleString
                                ("COMMAND_HELP_16") + ChatColor.DARK_AQUA + "--------------");
                        break;
    ...
    private void sendHelpMessages(Player p, int page, String... args) {
        p.sendMessage(ChatColor.GOLD + "--------------" + ChatColor.DARK_AQUA + "[The Survival Games]" + ChatColor
                .DARK_AQUA + "--------------");
