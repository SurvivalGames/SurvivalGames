        ...
        switch (index) {
            case 0:
                for (String s : (List<String>) o) {
                    ...
                    SGApi.getArenaManager().getCreators().put(strings[0], SGApi.getMultiWorldManager().worldForName
                            (strings[1]));
                }
                break;
            case 1:
            ...
            case 2:
                for (String s : (List<String>) o) {
                    String[] strings = s.split(":");
                    SGApi.getArenaManager().getInv().put(strings[0], ItemSerialization.stringToInventory(strings[1])
                            .getContents());
                }
                break;
            case 3:
