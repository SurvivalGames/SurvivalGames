...
import co.q64.paradisesurvivalgames.util.items.interfaces.*;
...
public class AbstractMenuItem implements ILore, IDisplayName, Selectable, SingleAction, IPermissible,
     ...
     */
    protected AbstractMenuItem(ItemStack item, Material material, ItemMeta meta, List<String> lore,
                               String displayName, Integer id, String permission,
    ...
    public static AbstractMenuItem deserialize(Map<String, Object> map) throws NullPointerException {
        ...
        Object oStack = map.get("item"), oId = map.get("id"), oPerm = map.get("permission"),
                oAct = map.get("activators");
        ...
        return new AbstractMenuItem(itemStack, itemStack.getType(), itemStack.getItemMeta(),
                itemStack.getItemMeta().getLore(), itemStack.getItemMeta().getDisplayName(), id, perm,
                action);
    }
