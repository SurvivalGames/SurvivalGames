		...
		if (cmd.equalsIgnoreCase("help")) {
			if (args.length == 0) {
				...
				try {
					...
					p.sendMessage(SGApi.getArenaManager().getError() + I18N.getLocaleString("NO_HELP"));
				}

				switch (page) {
				case 0:
					p.sendMessage(SGApi.getArenaManager().getError() + I18N.getLocaleString("NO_PAGE"));
					break;

				case 1:
					sendHelpMessages(p, 1, I18N.getLocaleString("COMMAND_HELP_1"), I18N.getLocaleString("COMMAND_HELP_2"), I18N.getLocaleString("COMMAND_HELP_69"), I18N.getLocaleString("COMMAND_HELP_3"), I18N.getLocaleString("COMMAND_HELP_4"), I18N.getLocaleString("COMMAND_HELP_5"));
					break;

				case 2:
					sendHelpMessages(p, 2, I18N.getLocaleString("COMMAND_HELP_6"), I18N.getLocaleString("COMMAND_HELP_96"), I18N.getLocaleString("COMMAND_HELP_7"), I18N.getLocaleString("COMMAND_HELP_8"), I18N.getLocaleString("COMMAND_HELP_9"), I18N.getLocaleString("COMMAND_HELP_10"));
					break;

				case 3:
					sendHelpMessages(p, 3, I18N.getLocaleString("COMMAND_HELP_11"), I18N.getLocaleString("COMMAND_HELP_12"), I18N.getLocaleString("COMMAND_HELP_13"), I18N.getLocaleString("COMMAND_HELP_14"), I18N.getLocaleString("COMMAND_HELP_15"));
