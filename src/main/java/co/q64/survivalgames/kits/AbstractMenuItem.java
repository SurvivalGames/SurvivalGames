...
package co.q64.survivalgames.kits;
...
import co.q64.survivalgames.util.items.interfaces.ActionActivator;
import co.q64.survivalgames.util.items.interfaces.IDisplayName;
import co.q64.survivalgames.util.items.interfaces.ILore;
import co.q64.survivalgames.util.items.interfaces.IPermissible;
import co.q64.survivalgames.util.items.interfaces.Selectable;
import co.q64.survivalgames.util.items.interfaces.SingleAction;
...
public class AbstractMenuItem implements ILore, IDisplayName, Selectable, SingleAction, IPermissible, ConfigurationSerializable {
	 ...
	 */
	protected AbstractMenuItem(ItemStack item, Material material, ItemMeta meta, List<String> lore, String displayName, Integer id, String permission, List<ActionActivator> activators) {
		this.item = item;
	...
	public static AbstractMenuItem deserialize(Map<String, Object> map) throws NullPointerException {
		...
		return new AbstractMenuItem(itemStack, itemStack.getType(), itemStack.getItemMeta(), itemStack.getItemMeta().getLore(), itemStack.getItemMeta().getDisplayName(), id, perm, action);
	}
