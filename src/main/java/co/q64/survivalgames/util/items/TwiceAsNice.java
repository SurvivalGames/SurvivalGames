...
package co.q64.survivalgames.util.items;
...
import co.q64.survivalgames.callables.RandomFirework;
...
public class TwiceAsNice implements Listener {
	...
	public void entityDamage(EntityDamageByEntityEvent event) {
		...
		if (event.getCause() != EntityDamageEvent.DamageCause.PROJECTILE && event.getCause() != EntityDamageEvent.DamageCause.BLOCK_EXPLOSION && event.getCause() != EntityDamageEvent.DamageCause.ENTITY_EXPLOSION)
			return;
