        ...
        if (event.getEntity() instanceof Player) {
            ...
            if (SGApi.getArenaManager().isInGame(damaged)) {
                ...
                if ((damaged.getHealth() - event.getDamage()) <= 0) {
                    ...
                    damaged.addPotionEffect(new PotionEffect(PotionEffectType.INVISIBILITY, 9999999, 1, false)); // Just
                                                                                                                 // for
                                                                                                                 // effect
            ...
            if ((damaged.getHealth() - event.getDamage()) <= 0) {
                ...
                TheSurvivalGames.getPlugin(TheSurvivalGames.class)
                                .getServer()
                                .broadcastMessage(ChatColor.translateAlternateColorCodes('&', "&e&l" + damaged.getDisplayName() + " &r&6" + I18N.getLocaleString("FAIL") + " &e&l"
                                        + event.getDamager()));
            }
        }
    }
